-- Migration: Update create_team_with_owner function to remove team_description
-- The teams.description column has been removed, so we need to update the function
