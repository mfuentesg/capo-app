  ...
  public: {
    Tables: {
      ...
      user_chord_definitions: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_chord_definitions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      add_song_to_playlist: {
        Args: { p_playlist_id: string; p_song_id: string }
        Returns: undefined
      }
      ...
      delete_expired_team_invitations: { Args: never; Returns: undefined }
